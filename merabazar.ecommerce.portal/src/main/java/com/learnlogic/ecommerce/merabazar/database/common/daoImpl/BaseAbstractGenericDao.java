...
////		 = (Class<EntityType>) ((ParameterizedType) getClass().getGenericSuperclass()).getActualTypeArguments()[0];
//		    
////		    @Autowired
////		    @Qualifier("sessionFactoryecommerce")
////		    private void setSessionFactoryecommerce(SessionFactory sessionFactory) {
